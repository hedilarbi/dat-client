  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        title={toggleLabel}
        className="absolute right-0 top-0 h-full w-11 flex items-center justify-center rounded-r-[9px] text-[#4c5058] hover:text-[#13243c] hover:bg-[#f8f7f2] focus:outline-none focus:ring-1 focus:ring-[#d9704f] disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer transition"
      >
        {visible ? (
